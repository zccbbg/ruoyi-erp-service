...
CREATE TABLE `wms_check_order`  (
  ...
  `total_qty` decimal(20, 2) NULL DEFAULT NULL COMMENT '盈亏数',
...
CREATE TABLE `wms_movement_order`  (
  ...
  `total_qty` decimal(10, 2) NULL DEFAULT NULL COMMENT '总数量',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(3) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `wms_receipt_order`  (
  ...
  `total_qty` decimal(10, 2) NULL DEFAULT NULL COMMENT '商品总数',
